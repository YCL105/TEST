...
parser.add_argument("--test_picture_path", default='./test_picture/', help="path of test datas.")  # 网络测试输入的图片路径
parser.add_argument("--test_label_path", default='./test_label/', help="path of test datas.")  # 网络测试输入的标签路径
